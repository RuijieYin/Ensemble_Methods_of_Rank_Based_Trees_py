...
def rrf(train_x, train_y):
    train_data_converted = convertGenepairs(np.array(train_x))
...
# build a Boosting with Logitboost Cost model with backstage stepwise fitting:

def blc_rfe(train_x, train_y):
    train_data_converted = convertGenepairs(np.array(train_x))
